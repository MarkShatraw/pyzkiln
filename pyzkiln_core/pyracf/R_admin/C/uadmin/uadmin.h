...
const char EBCDIC_BASE_KEY[8] =     { 0xc2, 0xc1 ,0xe2, 0xc5, 0x40, 0x40, 0x40, 0x40 };
const char EBCDIC_NAME_KEY[8] =     { 0xd5, 0xc1, 0xd4, 0xc5, 0x40, 0x40, 0x40, 0x40 };
const char EBCDIC_PASSWORD_KEY[8] = { 0xd7, 0xc1, 0xe2, 0xe2, 0xe6, 0xd6, 0xd9, 0xc4 };
const char EBCDIC_OWNER_KEY[8] =    { 0xd6, 0xe6, 0xd5, 0xc5, 0xd9, 0x40, 0x40, 0x40 };
const char EBCDIC_SPECIAL_KEY[8] =  { 0xe2, 0xd7, 0xc5, 0xc3, 0xc9, 0xc1, 0xd3, 0x40 };
...
// OMVS segment
// Padded with 0x40 (blank) to match what r_admin assembler interface expects.
const char EBCDIC_OMVS_KEY[8] =    { 0xd6, 0xd4, 0xe5, 0xe2, 0x40, 0x40, 0x40, 0x40 };
const char EBCDIC_UID_KEY[8] =     { 0xe4, 0xc9, 0xc4, 0x40, 0x40, 0x40, 0x40, 0x40 };
const char EBCDIC_HOME_KEY[8] =    { 0xc8, 0xd6, 0xd4, 0xc5, 0x40, 0x40, 0x40, 0x40 };
const char EBCDIC_PROGRAM_KEY[8] = { 0xd7, 0xd9, 0xd6, 0xc7, 0xd9, 0xc1, 0xd4, 0x40 };
