...
void* uadmin_build_base_segment(BYTE *finger, KV_CTL_T * pKVCTL_req, BASE_SEGMENT_T *base_segment, LOGGER_T *pLog) {
   ...
   ebcdic_base_key[0] = 0xc2;
   ebcdic_base_key[1] = 0xc1;
   ebcdic_base_key[2] = 0xe2;
   ebcdic_base_key[3] = 0xc5;
   ebcdic_base_key[4] = 0x40;
   ebcdic_base_key[5] = 0x40;
   ebcdic_base_key[6] = 0x40;
   ebcdic_base_key[7] = 0x40;
